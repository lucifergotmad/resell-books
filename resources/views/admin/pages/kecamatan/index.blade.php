@extends('layouts.admin', ['title' => 'Data Kecamatan'])
        ...
        <div class="toolbar py-12" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Daftar Kecamatan</h1>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title container">
                            <form action="{{ route('kecamatan.index') }}" style="width: 100%">
                                <div class="d-flex align-items-center justify-content-between position-relative my-6">
                                    ...
                                    <div class="d-flex align-items-center justify-content-start">
                                        ...
                                        <input type="text" name="keyword" data-kt-user-table-filter="search"
                                            ...
                                            placeholder="Cari data kecamatan" value="{{ request('keyword') }}">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                        ...
                                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                                            <div class="mb-10">
                                                <label class="form-label fs-6 fw-bold">Kota:</label>
                                ...
                                <div class="row px-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-10">
                                            ...
                                            <input id="kode_kecamatan" minlength="1" maxlength="4" type="text"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-10">
                                            ...
                                            <input id="nama_kecamatan" type="text" name="nama_kecamatan"
                                                class="form-control" placeholder="Baleendah" autocomplete="false" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row px-4">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <button type="button"
                                                                ...
                                                                data-bs-target="#kt_modal_{{ $kecamatan->id }}">Hapus</button>
                                                        </div>
                                                    </div>
                                                    <div class="modal fade text-start" tabindex="-1"
                                                        id="kt_modal_{{ $kecamatan->id }}">
