@extends('layouts.admin', ['title' => 'Data Kategori'])
        ...
        <div class="toolbar py-12" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Daftar Kategori</h1>
                </div>
            </div>
        </div>
                        ...
                        <div id="kt_content_container" class="container-xxl">
                            <form action="{{ route('kategori.store') }}" method="POST">
                                ...
                                <div class="row px-4">
                                    <div class="col-lg-6">
                                        <div class="mb-10">
                                            <label for="kode_kategori" class="required form-label">Kode
                                                Kategori</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-10">
                                            <label for="nama_kategori" class="required form-label">Nama
                                                Kategori</label>
                                            <input id="nama_kategori" type="text" name="nama_kategori"
                                                class="form-control" placeholder="Fiksi" autocomplete="false" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row px-4">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <button type="button"
                                                                    ...
                                                                    data-bs-target="#kt_modal_{{ $kategori->id }}">Hapus</button>
                                                            </div>
                                                        </div>

                                                        <div class="modal fade text-start" tabindex="-1"
                                                            id="kt_modal_{{ $kategori->id }}">
