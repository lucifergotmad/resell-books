                ...
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title container">
                            <form action="{{ route('buku.index') }}" style="width: 100%">
                                <div class="d-flex align-items-center justify-content-between position-relative my-6">
                                    ...
                                    <div class="d-flex align-items-center justify-content-start">
                                        ...
                                        <input type="text" name="keyword" data-kt-user-table-filter="search"
                                            ...
                                            placeholder="Cari data buku" value="{{ request('keyword') }}">
                                    ...
                                    <tbody class="text-gray-600 fw-bold">
                                        @foreach ($bukus as $index => $buku)
                                            <tr class={{ ($index + 1) % 2 ? 'odd' : 'even' }}>
                                                ...
                                                <td>{{ round($buku->berat, 3) }}gr</td>
                                                <td>Rp. {{ $buku->harga_jual }},00</td>
                                                <td>Rp. {{ $buku->harga_sewa }},00</td>
                                                <td>{{ $buku->penerbit }}</td>
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <button type="button"
                                                                ...
                                                                data-bs-target="#kt_modal_{{ $buku->id }}">Hapus</button>
                                                        </div>
                                                    </div>
                                                    <div class="modal fade text-start" tabindex="-1"
                                                        id="kt_modal_{{ $buku->id }}">
