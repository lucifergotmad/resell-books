        ...
        <div class="toolbar py-12" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Daftar Buku</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
            </div>
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="Cari data buku">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                                    ...
                                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                                        <div class="mb-10">
                                            ...
                                            <select
                                                ...
                                                <option value="Administrator">Fiksi</option>
                                                <option value="Administrator">Horror</option>
                                                <option value="Administrator">Ilmu Pengetahuan</option>
                                            </select>
                                        </div>
                                        <!--begin::Actions-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <tbody class="text-gray-600 fw-bold">
                                    ...
                                    <tr class="even">
                                        ...
                                        <td>TB-220114-002</td>
                                        <td>Cinta Dalam Gelas</td>
                                        <td>Fiksi</td>
                                        <td>Andrea Hirata</td>
                                        <td>400g</td>
                                        <td>Rp. 120.000,00</td>
                                        <td>Rp. 13.000,00/Hari</td>
                                        <td>Gramedia</td>
                                        <td>2015</td>
