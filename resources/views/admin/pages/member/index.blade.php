@extends('layouts.admin', ['title' => 'Data Member'])
        ...
        <div class="toolbar py-12" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Daftar Member</h1>
                </div>
            </div>
        </div>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        <form action="{{ route('member.store') }}" method="POST">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-10">
                                        ...
                                        <input id="kode_member" type="text" name="kode_member" class="form-control"
                                            placeholder="MB-000001" autocomplete="false" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-10">
                                        <label for="nama_member" class="required form-label">Nama
                                            Member</label>
                                        <input id="nama_member" type="text" name="nama_member" class="form-control"
                            ...
                            <div class="row px-4">
                                <div class="col-lg-4">
                                    <div class="mb-10">
                                        <label for="no_ktp" class="required form-label">NIK</label>
                                        <input id="no_ktp" type="text" name="no_ktp" class="form-control"
                                            placeholder="353522810001" autocomplete="false" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-10">
                                        <label for="no_hp" class="required form-label">No Handphone</label>
                                        <input id="no_hp" type="text" name="no_hp" class="form-control"
                                            placeholder="081321832034" autocomplete="false" />
                                    </div>
                                </div>
                            </div>
                            <div class="row px-4">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('alamat.index', ['id' => $member->id]) }}"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <button type="button"
                                                                ...
                                                                data-bs-target="#kt_modal_{{ $member->id }}">Hapus</button>
                                                        </div>
                                                    </div>

                                                    <div class="modal fade text-start" tabindex="-1"
                                                        id="kt_modal_{{ $member->id }}">
