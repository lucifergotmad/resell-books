    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('rekening.index') }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('provinsi.index') }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('kota.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: assets/media/icons/duotune/maps/map002.svg-->
                            <span class="svg-icon svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('kecamatan.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: assets/media/icons/duotune/maps/map002.svg-->
                            <span class="svg-icon svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('terima-buku.index') }}">
                        <span class="menu-icon">
